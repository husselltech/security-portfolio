...
What I'd do differently: Next time, I would check the policy's Effect earlier in the investigation, since that quickly explains whether Azure is configured to prevent or simply report 
violations.
